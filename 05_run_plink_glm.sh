...
plink2 --import-dosage ${LANC_DIR}/lanctotals/${study}/${chr}/${study}_${chr}.total.anc2.msp.tsv format=1 noheader \
 --fam $fam_file --glm local-covar=${LANC_DIR}/lanctotals/${study}/${chr}/${study}_${chr}.total.covar.msp.tsv \
